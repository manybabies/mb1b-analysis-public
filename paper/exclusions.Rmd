...
* *Full-term*. We defined full term as gestation times greater than or equal to 37 weeks. There were `r full_term$percents$any_sum` (`r round(full_term$percents$any_mean*100, 2)`%) infants who were tested but did not meet this criterion.
