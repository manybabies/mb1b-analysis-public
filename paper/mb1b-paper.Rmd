...
row_names_LMM1 <- c("Intercept", "IDS", "HPP", "Single Screen", 
                     ...
                     "IDS * Age * Bilingual", "R2_conditional", "R2_marginal")
...
coefs_matched <- rbind(coefs_matched, r2cond, r2marg)
...
coefs_unmatched <- rbind(coefs_unmatched, r2cond, r2marg)
...
papaja::apa_table(nae_exp_coef, format.args = list(digits = 3),
...
papaja::apa_table(nae_only_coef, format.args = list(digits = 3),
